...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="container">
                <form action="{{route('admin.sections.update',$section->id)}}" method="put" class="submit-form">
                    ...
                    @foreach ($section->SectionContent as $ss)


                    <div id="dynamic_field">
                        @if($ss->type == 'text')
                        <div class="col-12" id="text_div_<?php print $ss->id; ?>">
                            <div class="card card-success border-success">
                                ...
                                <input type="text" name="name_input[]" placeholder="اسم النص  " class="form-control name_list" value="{{$ss->name}}" />
                                <br>
                                <div class="col-md-6 col-sm-6 form-group mb-4">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text font-weight-bold"> سطر جديد&nbsp</span></div><input type="checkbox" name="new_line[]" class="form-control new_line_list" {{$ss->new_line == 1 ? "checked":""}} />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 form-group mb-4">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text font-weight-bold"> عنوان&nbsp</span></div><input type="checkbox" name="is_title[]" class="form-control is_title_list" {{$ss->is_title == 1 ? "checked":""}} />
                                    </div>
                                </div>
                        ...
                        <br>
                        @endif
                        @if($ss->type == 'text1' || $ss->type == 'date')
                        <div class="col-12" id="text_div_<?php print $ss->id; ?>">
                            <div class="card card-warning border-warning">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-11 col-sm-11 col-md-11">
                                            <h5 class=""> حقل الادخال
                                            </h5>
                                        </div>
                                        <div class="col-1 col-sm-1 col-md-1">
                                            <div class="card-tools">
                                                <button type="button" class="btn btn-danger" onclick="removetext(<?php print $ss->id; ?>)"><i class="fas fa-trash"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <input type="text" name="name_input_input[]" placeholder="اسم حقل الإدخال  " class="form-control name_input_input" value="{{$ss->name}}" />
                                <br>
                                <div class="input-group">
                                    ...
                                    <select name="type_input_name" id="type_input_name" class="form-control" required>
                                        <option></option>
                                        <option value="date" {{ $ss->type == 'date' ? 'selected' : '' }}>تاريخ</option>
                                        <option value="text1" {{ $ss->type == 'text1' ? 'selected' : '' }}>نص</option>
                                    </select>
                                </div>
                                <br>
                                ...
                                <div class="col-md-6 col-sm-6 form-group mb-4">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text font-weight-bold"> سطر جديد&nbsp</span></div><input type="checkbox" name="new_line[]" class="form-control new_line_list" {{$ss->is_title == 1 ? "checked":""}} />
                                    </div>
                                </div>
                        ...
                        <div class="col-12" id="text_div_<?php print $ss->id; ?>">
                            <div class="card card-danger border-danger">
                                ...
                                <label for="dropdown_name_input">اسم القائمة المنسدله</label>
                                <input type="text" name="dropdown_name_input[]" placeholder="اسم  القائمة المنسدلة  " class="form-control dropdown_name_list" value="{{$ss->name}}" />
                                 <input type="hidden" name="dropdon_id[]" value="{{$ss->id}}">   
                                <br>


                                @foreach($drops as $drop)
                                <div class="col-12" id="text_div_<?php print $drop->id; ?>">
                                    <div class="card card-dark border-dark">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-11 col-sm-11 col-md-11">
                                                    <h5 class=""> عناصر القائمة المنسدله:{{$drop->id}}
                                                    </h5>
                                                </div>
                                                <div class="col-1 col-sm-1 col-md-1">
                                                    <div class="card-tools">
                                                        <button type="button" class="btn btn-danger" onclick="removetext(<?php print $drop->id; ?>)"><i class="fas fa-trash"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <input type="text" name="element_name[]" value="{{$drop->name}}" placeholder="اسم   العنصر  " class="form-control element_name_list" />
                                        <br>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <select id="section" name="section" class="form-control">
                                                ...
                                                <option value="{{ $se->id }}" {{ $drop->section_id == $se->id ? "selected":""}}>{{ $se->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
